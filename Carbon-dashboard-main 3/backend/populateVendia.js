...
const client = createVendiaClient({
  apiUrl:
    ...
    'https://t82dup90u8.execute-api.us-west-1.amazonaws.com/graphql',
  websocketUrl:
    process.env.VENDIA_GRAPHQL_WEBSOCKET_URL ||
    'wss://is1io8ad8f.execute-api.us-west-1.amazonaws.com/graphql',
  apiKey:
    process.env.VENDIA_API_KEY ||
    '72Lawtsuk1cqxuwgE4RxtuNLJ8PtPpfLuDLmtLWkQL5C',
});
